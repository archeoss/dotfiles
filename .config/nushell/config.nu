...
"" | save --force ~/.config/nushell/aliasrc.nu
def make-alias [] {
    append "\n" | str join "\n" | save --append ~/.config/nushell/aliasrc.nu
}

# sudo not required for some system commands
[mount, umount, sv, pacman, updatedb, su, shutdown, poweroff, reboot] | each { | command | $"alias ($command) = sudo ($command)" } | make-alias
...
[
	...
	"YT = youtube-viewer",
	"sdn = shutdown -h now",
	"v = neovide --multigrid --maximized --novsync",
	"p = pacman",
...
[
    ...
    "todoist = todoist --enable-features=UseOzonePlatform,WaylandWindowDecorations --ozone-platform=wayland"
    "obsidian = obsidian --enable-features=UseOzonePlatform,WaylandWindowDecorations --ozone-platform=wayland"
    "logseq = logseq --enable-features=UseOzonePlatform,WaylandWindowDecorations --ozone-platform=wayland"
]
    | each { | command | $"alias ($command)" } | make-alias
